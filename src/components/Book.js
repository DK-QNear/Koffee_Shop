...
function Book() {
  ...
  return (
    <div className='whole'>
      {/* <ReactCalendar minDate={new Date()} className='REACT-CALENDAR p-2' view='month' onClickDay={(date)=>console.log(date)}/> */}
      <BookingHome />
      <div className="wrapper">
        <div className="content">
          ...
          <div className="c1">
            <span>Become a member of MyKoffee Shop today</span>
          </div>
          <div className="form">
